...
const en = {
  ...
  edit: "Edit",
  markdownEmpty: "Empty — click to write",
  markdownHint: "Markdown: **bold**, # heading, - list, [link](url). ⌘↩ to save",
  ...
  taskFieldsColumnHint: "A task filling the window has two columns: a wide one for content and a narrow one for short answers. The icon in a row moves a field between them.",
  moveFieldToSide: "Move to the narrow column",
  moveFieldToMain: "Move to the wide column",
  addField: "Add a field",
  fieldName: "Name",
  fieldType: "Type",
  fieldOptions: "Choices",
  fieldOptionsHint: "One per line",
  builtinField: "Built-in",
  removedFields: "Removed fields",
  removedFieldsHint: "Their values are kept — bring the field back and its content comes with it.",
  restoreField: "Restore",
  removeFieldConfirm: (name: string) => `Remove the field "${name}"? Its values stay and return with it.`,
  fieldKinds: {
    text: "Text",
